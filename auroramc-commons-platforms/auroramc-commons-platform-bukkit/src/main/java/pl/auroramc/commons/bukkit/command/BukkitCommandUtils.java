package pl.auroramc.commons.bukkit.command;

import static java.util.Locale.ROOT;

import pl.auroramc.commons.command.CommandResolvingException;

public final class BukkitCommandUtils {

  private static final String ARGUMENT_SEPARATOR = " ";
  private static final String COMMAND_PREFIX = "/";
  private static final String COMMAND_NAMESPACE_SEPARATOR = ":";

  private BukkitCommandUtils() {}
